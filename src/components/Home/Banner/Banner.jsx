    ...
    <div>
      ...
      >
        <SwiperSlide style={{position: "relative"}}>
          ...
          <div style={{position: "absolute", top: '300px', marginLeft:'300px'}}>
            <h2 style={{fontSize: '40px'}}>Beauty and Care</h2>
        ...
        <SwiperSlide style={{position: "relative"}}>
          ...
          <div style={{position: "absolute", top: '300px', marginLeft:'300px'}}>
            <h2 style={{fontSize: '40px'}}>Grocery Products</h2>
        ...
        <SwiperSlide style={{position: "relative"}}>
          ...
          <div style={{position: "absolute", top: '300px', marginLeft:'300px'}}>
            <h2 style={{fontSize: '40px'}}>Vegetables and Fruits</h2>
        ...
        <SwiperSlide style={{position: "relative"}}>
          ...
          <div style={{position: "absolute", top: '300px', marginLeft:'300px'}}>
            <h2 style={{fontSize: '40px'}}>Comfortable Dresses</h2>
            <h2 style={{fontSize: '20px', color:'yellow', marginTop:'0px'}}>Buy and get 20% off</h2>
            <button>Buy Now</button>
          </div>
        </SwiperSlide>
        <SwiperSlide style={{position: "relative"}}>
          ...
          <div style={{position: "absolute", top: '300px', marginLeft:'300px'}}>
            <h2 style={{fontSize: '40px'}}>Glasses</h2>
            <h2 style={{fontSize: '20px', color:'yellow', marginTop:'0px'}}>Buy and get 20% off</h2>
            <button>Buy Now</button>
          </div>
        </SwiperSlide>
        <SwiperSlide style={{position: "relative"}}>
          ...
          <div style={{position: "absolute", top: '300px', marginLeft:'300px'}}>
            <h2 style={{fontSize: '40px'}}>Sneakers</h2>
